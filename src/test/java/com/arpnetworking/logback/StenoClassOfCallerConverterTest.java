...
/**
 * Tests for <code>StenoClassOfCallerConverter</code>.
 *
 * @author Ville Koskela (ville dot koskela at inscopemetrics dot com)
 */
public class StenoClassOfCallerConverterTest {
    ...
    private final ClassicConverter _converter = new StenoClassOfCallerConverter();
