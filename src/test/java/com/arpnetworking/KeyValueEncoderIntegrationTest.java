...
/**
 * Simple integration test of the {@link com.arpnetworking.logback.KeyValueEncoder}.
 *
 * @author Ville Koskela (ville dot koskela at inscopemetrics dot io)
 */
public class KeyValueEncoderIntegrationTest extends BaseKeyValueIntegrationTest {

    // CHECKSTYLE.OFF: StrictDuplicateCode - Same basic tests as StenoEncoderIntegrationTest
    @Test
    public void test() {
